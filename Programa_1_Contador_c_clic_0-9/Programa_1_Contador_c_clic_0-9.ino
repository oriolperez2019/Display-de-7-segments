...
void loop()
{                            
  digitalWrite(ledA, LOW);    // posar a 5V el pin 5  Nº0
  ...
  digitalWrite(ledG, HIGH);    // posar a 0V el pin 11
  
  
  delay(a);                  // es queden leds 500ms encesos
                             
  digitalWrite(ledA, HIGH);    // posar a 5V el pin 5   Nº1
  digitalWrite(ledB, LOW);    // posar a 5V el pin 6
  digitalWrite(ledC, LOW);    // posar a 5V el pin 7
  ...
  digitalWrite(ledA, LOW);    // posar a 5V el pin 5  Nº2
  digitalWrite(ledB, LOW);    // posar a 5V el pin 6
  ...
  digitalWrite(ledA, LOW);    // posar a 5V el pin 5   Nº3
  digitalWrite(ledB, LOW);    // posar a 5V el pin 6
  digitalWrite(ledC, LOW);    // posar a 5V el pin 7
  digitalWrite(ledD, LOW);    // posar a 5V el pin 8
  digitalWrite(ledE, HIGH);    // posar a 5V el pin 9
  ...
  digitalWrite(ledA, HIGH);    // posar a 5V el pin 5   Nº4
  digitalWrite(ledB, LOW);    // posar a 5V el pin 6
  digitalWrite(ledC, LOW);    // posar a 5V el pin 7
  digitalWrite(ledD, HIGH);    // posar a 5V el pin 8
  digitalWrite(ledE, HIGH);    // posar a 5V el pin 9
  ...
  digitalWrite(ledA, LOW);    // posar a 5V el pin 5  Nº5
  ...
  digitalWrite(ledA, HIGH);    // posar a 5V el pin 5    Nº6
  digitalWrite(ledB, HIGH);    // posar a 5V el pin 6
  digitalWrite(ledC, LOW);    // posar a 5V el pin 7
  digitalWrite(ledD, LOW);    // posar a 5V el pin 8
  digitalWrite(ledE, LOW);    // posar a 5V el pin 9
  ...
  digitalWrite(ledA, LOW);    // posar a 5V el pin 5   Nº7
  digitalWrite(ledB, LOW);    // posar a 5V el pin 6
  digitalWrite(ledC, LOW);    // posar a 5V el pin 7
  digitalWrite(ledD, HIGH);    // posar a 5V el pin 8
  digitalWrite(ledE, HIGH);    // posar a 5V el pin 9
  ...
  digitalWrite(ledA, LOW);    // posar a 5V el pin 5    Nº8
  digitalWrite(ledB, LOW);    // posar a 5V el pin 6
  digitalWrite(ledC, LOW);    // posar a 5V el pin 7
  digitalWrite(ledD, LOW);    // posar a 5V el pin 8
  digitalWrite(ledE, LOW);    // posar a 5V el pin 9
  ...
  digitalWrite(ledA, LOW);    // posar a 5V el pin 5   Nº9
  digitalWrite(ledB, LOW);    // posar a 5V el pin 6
  digitalWrite(ledC, LOW);    // posar a 5V el pin 7
  digitalWrite(ledD, HIGH);    // posar a 5V el pin 8
  digitalWrite(ledE, HIGH);    // posar a 5V el pin 9
